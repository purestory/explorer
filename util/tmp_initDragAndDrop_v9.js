function initDragAndDrop() {
    ...
    function handleFileDragStart(e) {
        // *** 추가: 드래그 시작 시 fileList 높이 고정 ***
        const fileListElement = document.getElementById('fileList');
        if (fileListElement) {
            const currentHeight = fileListElement.offsetHeight;
            fileListElement.style.minHeight = `${currentHeight}px`;
            console.log(`handleFileDragStart: fileList min-height 설정: ${currentHeight}px`);
        }
        // *** 추가 끝 ***
    ...
    function handleFileDragEnd(e) {
        // *** 추가: 드래그 종료 시 fileList 높이 고정 해제 ***
        const fileListElement = document.getElementById('fileList');
        if (fileListElement) {
            fileListElement.style.minHeight = ''; // min-height 스타일 제거
            console.log('handleFileDragEnd: fileList min-height 해제');
        }
        // *** 추가 끝 ***
